...
overdueContactsSimplified i =
  St.overdueContacts i
...
overdueContactsSpec =
  describe "overdueContacts" do
    it "can get list of overdue contacts, from most overdue to least overdue" do
      ...
      let
        now = dateToInstant $ newDate 2020 1 10
      overdueContactsSimplified now (spy "state" state)
        `shouldEqual`
