-- Module copied from the internet for the purposes of the Main demo
-- https://github.com/alpacaaa/elm-to-purescript-cheatsheet/blob/master/elm-architecture/src/Common/Svg.purs
