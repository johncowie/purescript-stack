...
(function($PS) {
  ...
  var user = function (uri) {
      var userInfo = Control_Bind.join(Data_Maybe.bindMaybe)(Data_Lens_Fold.lastOf((function () {
          var $11 = URI_AbsoluteURI["_hierPart"](Data_Lens_Internal_Forget.strongForget);
          var $12 = URI_HierarchicalPart["_authority"](Data_Lens_Internal_Forget.wanderForget(Data_Maybe_Last.monoidLast));
          var $13 = URI_Authority["_userInfo"](Data_Lens_Internal_Forget.strongForget);
          return function ($14) {
              return $11($12($13($14)));
          };
      })())(uri));
      return Data_Functor.map(Data_Maybe.functorMaybe)(Data_Functor.map(Data_Functor.functorFn)(Data_Functor.map(Data_Functor.functorFn)(Data_Show.show(Data_String_NonEmpty_Internal.showNonEmptyString))(function (v) {
          return v.user;
  ...
  var port = function (uri) {
      return Control_Bind.bind(Data_Maybe.bindMaybe)(Control_Bind.join(Data_Maybe.bindMaybe)(Data_Lens_Fold.lastOf((function () {
          var $15 = URI_AbsoluteURI["_hierPart"](Data_Lens_Internal_Forget.strongForget);
          var $16 = URI_HierarchicalPart["_authority"](Data_Lens_Internal_Forget.wanderForget(Data_Maybe_Last.monoidLast));
          var $17 = URI_Authority["_hosts"](Data_Lens_Internal_Forget.strongForget);
          return function ($18) {
              return $15($16($17($18)));
          };
      })())(uri)))(function (hostPortPair) {
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_These.theseRight(hostPortPair))(function (port1) {
              return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(URI_Port.toInt(port1));
          });
      });
  };
  ...
  var password = function (uri) {
      var userInfo = Control_Bind.join(Data_Maybe.bindMaybe)(Data_Lens_Fold.lastOf((function () {
          var $19 = URI_AbsoluteURI["_hierPart"](Data_Lens_Internal_Forget.strongForget);
          var $20 = URI_HierarchicalPart["_authority"](Data_Lens_Internal_Forget.wanderForget(Data_Maybe_Last.monoidLast));
          var $21 = URI_Authority["_userInfo"](Data_Lens_Internal_Forget.strongForget);
          return function ($22) {
              return $19($20($21($22)));
          };
      })())(uri));
      return Data_Functor.map(Data_Maybe.functorMaybe)(Data_Functor.map(Data_Functor.functorFn)(Data_Functor.map(Data_Functor.functorFn)(Data_Show.show(Data_Maybe.showMaybe(Data_String_NonEmpty_Internal.showNonEmptyString)))(function (v) {
          return v.password;
      }))(Data_Newtype.unwrap(URI_Extra_UserPassInfo.newtypeUserPassInfo)))(userInfo);
  };
  var options = {
  ...
  var host = function (uri) {
      return Control_Bind.bind(Data_Maybe.bindMaybe)(Control_Bind.join(Data_Maybe.bindMaybe)(Data_Lens_Fold.lastOf((function () {
          var $23 = URI_AbsoluteURI["_hierPart"](Data_Lens_Internal_Forget.strongForget);
          var $24 = URI_HierarchicalPart["_authority"](Data_Lens_Internal_Forget.wanderForget(Data_Maybe_Last.monoidLast));
          var $25 = URI_Authority["_hosts"](Data_Lens_Internal_Forget.strongForget);
          return function ($26) {
              return $23($24($25($26)));
          };
      })())(uri)))(function (hostPortPair) {
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_These.theseLeft(hostPortPair))(function (host1) {
              return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(URI_Host.print(host1));
          });
      });
  };
  var database = function (uri) {
      var databaseM = Control_Bind.join(Data_Maybe.bindMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(pathHead)(Data_Lens_Fold.lastOf((function () {
          var $27 = URI_AbsoluteURI["_hierPart"](Data_Lens_Internal_Forget.strongForget);
          var $28 = URI_HierarchicalPart["_path"](Data_Lens_Internal_Forget.wanderForget(Data_Maybe_Last.monoidLast));
          return function ($29) {
              return $27($28($29));
          };
      })())(uri)));
  ...
  var uriToConfig = function (uri) {
      return Control_Bind.bind(Data_Either.bindEither)(database(uri))(function (database1) {
...
(function($PS) {
  ...
  var showDBError = function (v) {
      ...
      throw new Error("Failed pattern match at Server.DB (line 72, column 1 - line 72, column 64): " + [ v.constructor.name ]);
  };
  ...
  var getDB = function (dbUri) {
      ...
      throw new Error("Failed pattern match at Server.DB (line 77, column 15 - line 82, column 22): " + [ v.constructor.name ]);
  };
