...
(function($PS) {
  ...
  var createConnectionPool = function (dbName) {
      return Database_PostgreSQL.newPool((function () {
  ...
  var getDB = createConnectionPool("events_store");
...
(function($PS) {
  ...
  var jsonResponse = function (dictEncodeJson) {
      return function (status) {
          var $82 = response(status);
          var $83 = Data_Argonaut_Encode_Class.encodeJson(dictEncodeJson);
          return function ($84) {
              return $82($83($84));
          };
      };
  ...
  var main = function __do() {
      var config = Data_Functor.map(Effect.functorEffect)(TypedEnv.fromEnv(TypedEnv.readEnvImpl()()(TypedEnv.readEnvFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "port";
      }))(new Data_Symbol.IsSymbol(function () {
          return "PORT";
      }))()(TypedEnv.readEnvFieldsNil(Type_Equality.refl))()()(TypedEnv.readValueOptional(TypedEnv.parseValueInt)))()())(Type_Data_Row.RProxy.value))(Node_Process.getEnv)();
      if (config instanceof Data_Either.Left) {
          return Effect_Console.log("ERROR: " + TypedEnv.envErrorMessage(config.value0))();
      };
