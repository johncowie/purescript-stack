...
(function($PS) {
      ...
      return function (url) {
          return function (e) {
              ...
              return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.request({
                  ...
                  throw new Error("Failed pattern match at Utils.AppendStore (line 88, column 3 - line 90, column 40): " + [ result.constructor.name ]);
              });
          };
      };
  };
  var appendHTTP = function (dictEncodeJson) {
      return function (s) {
          return function (event) {
              return apiPost(dictEncodeJson)(rootUrl + ("?app=" + s))(event);
          };
      };
  };
  var saveSnapshotHTTP = function (dictEncodeJson) {
      return function (app) {
          return apiPost(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(dictEncodeJson)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonInt)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
              return "upToEvent";
          }))())(new Data_Symbol.IsSymbol(function () {
              return "state";
      ...
      return function (url) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.request({
              ...
              if (result instanceof Data_Either.Right) {
                  ...
                  throw new Error("Failed pattern match at Utils.AppendStore (line 75, column 23 - line 79, column 43): " + [ v.constructor.name ]);
              };
              throw new Error("Failed pattern match at Utils.AppendStore (line 73, column 3 - line 79, column 43): " + [ result.constructor.name ]);
          });
      };
  };
      ...
      return function (url) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.request({
              ...
              if (result instanceof Data_Either.Right) {
                  ...
                  throw new Error("Failed pattern match at Utils.AppendStore (line 63, column 23 - line 65, column 44): " + [ v.constructor.name ]);
              };
              throw new Error("Failed pattern match at Utils.AppendStore (line 61, column 3 - line 65, column 44): " + [ result.constructor.name ]);
          });
      };
  };
  var retrieveAllHTTP = function (dictDecodeJson) {
      return function (s) {
          return apiGet(Data_Argonaut_Decode_Class.decodeArray(dictDecodeJson))(rootUrl + ("?app=" + s));
      };
  };
  var httpAppendStore = function (dictDecodeJson) {
      return function (dictEncodeJson) {
          return function (k) {
              return {
                  append: appendHTTP(dictEncodeJson)(k),
                  retrieveAll: retrieveAllHTTP(dictDecodeJson)(k)
              };
          };
      };
  };
...
(function($PS) {
  ...
  var ProcessEvents = (function () {
      function ProcessEvents(value0) {
          this.value0 = value0;
      };
      ProcessEvents.create = function (value0) {
          return new ProcessEvents(value0);
      };
          ...
          var tickSubM = (function () {
              if (eventApp.tick instanceof Data_Maybe.Just) {
                  return Data_Maybe.Just.create(Utils_Spork_TimerSubscription.tickSub(function (i) {
                      return Data_Either.Right.create(eventApp.tick.value0.value0(i));
                  }));
              };
              return Data_Maybe.Nothing.value;
          })();
  ...
  var mkRender = function (eventApp) {
      var $42 = Data_Functor.map(Spork_Html_Core.functorHtml)(Data_Either.Right.create);
      return function ($43) {
          return $42(eventApp.render($43));
      };
  };
  ...
  var mkInit = function (eventApp) {
      var allEffects = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Control_Applicative.pure(Effect_Aff.applicativeAff)(new Data_Either.Left(LoadEvents.value)) ])(mapmap(Data_Functor.functorArray)(Effect_Aff.functorAff)(Data_Either.Right.create)(eventApp.init.effects));
      return {
  ...
  var alertError = function (err) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Utils_Alert.alert(err)))(function () {
          return Control_Applicative.pure(Effect_Aff.applicativeAff)(new Data_Either.Left(DoNothing.value));
      });
  };
  var mkUpdate = function (v) {
      return function (v1) {
          return function (v2) {
              if (v2 instanceof Data_Either.Right) {
                  var v3 = v.update(v1)(v2.value0);
                  var updatedModel = Utils_Lens.over(v["_state"])(function (s) {
                      return Data_Foldable.foldr(Data_Foldable.foldableArray)(v.reducer)(s)(v3.events);
                  })(v3.model);
                  var storeEventEffects = Data_Functor.mapFlipped(Data_Functor.functorArray)(v3.events)(function (event) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(v.eventStore.append(event))(function (result) {
                          if (result instanceof Data_Either.Left) {
                              return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Either.Left.create(new AlertError(Data_Show.show(Effect_Exception.showError)(result.value0))));
                          };
                          return Control_Applicative.pure(Effect_Aff.applicativeAff)(new Data_Either.Left(DoNothing.value));
                      });
                  });
                  var allEvents = Spork_Batch.batch(Data_Semigroup.append(Data_Semigroup.semigroupArray)(storeEventEffects)(mapmap(Data_Functor.functorArray)(Effect_Aff.functorAff)(Data_Either.Right.create)(v3.effects)));
                  return {
                      effects: allEvents,
                      model: updatedModel
                  };
              };
              if (v2 instanceof Data_Either.Left && v2.value0 instanceof ProcessEvents) {
                  var updatedModel = Utils_Lens.over(v["_state"])(function (s) {
                      return Data_Foldable.foldr(Data_Foldable.foldableArray)(v.reducer)(s)(v2.value0.value0);
                  })(v1);
                  return Spork_Transition.purely(updatedModel);
              };
              if (v2 instanceof Data_Either.Left && v2.value0 instanceof LoadEvents) {
                  var load = Control_Bind.bind(Effect_Aff.bindAff)(v.eventStore.retrieveAll)(function (eventsE) {
                      if (eventsE instanceof Data_Either.Right) {
                          return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Either.Left.create(new ProcessEvents(eventsE.value0)));
                      };
                      if (eventsE instanceof Data_Either.Left) {
                          return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Either.Left.create(AlertError.create(Data_Show.show(Effect_Exception.showError)(eventsE.value0))));
                      };
                      throw new Error("Failed pattern match at Utils.Spork.EventApp (line 119, column 11 - line 121, column 62): " + [ eventsE.constructor.name ]);
                  });
                  return {
              ...
              if (v2 instanceof Data_Either.Left && v2.value0 instanceof AlertError) {
                  return {
                      effects: Spork_Batch.batch([ alertError(v2.value0.value0) ]),
                      model: v1
                  };
              };
              if (v2 instanceof Data_Either.Left && v2.value0 instanceof DoNothing) {
                  return Spork_Transition.purely(v1);
              };
              throw new Error("Failed pattern match at Utils.Spork.EventApp (line 100, column 1 - line 104, column 67): " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
          };
      };
  };
...
(function($PS) {
  ...
  var LoadedEvents = (function () {
      function LoadedEvents(value0) {
          this.value0 = value0;
      };
      LoadedEvents.create = function (value0) {
          return new LoadedEvents(value0);
      };
      return LoadedEvents;
  })();
  var AlertError = (function () {
  ...
  var store = Utils_AppendStore.httpAppendStore(Dunbar_State.decodeJsonEvent)(Dunbar_State.encodeJsonEvent)("dunbar");
  ...
  var init = function (now) {
      ...
      var effects = [ Control_Applicative.pure(Effect_Aff.applicativeAff)(LoadEvents.value) ];
      return {
          effects: effects,
          model: model,
          events: [  ]
  ...
  var navigate = function (v) {
      return function (model) {
          ...
          throw new Error("Failed pattern match at Dunbar.App (line 201, column 1 - line 201, column 35): " + [ v.constructor.name, model.constructor.name ]);
      };
  };
  ...
  var render = function (model) {
      ...
      throw new Error("Failed pattern match at Dunbar.App (line 170, column 16 - line 173, column 51): " + [ model.page.constructor.name ]);
  };
  var _friendships = Utils_Lens.prop(new Data_Symbol.IsSymbol(function () {
      return "friendships";
  }))()(Data_Symbol.SProxy.value);
  var fireStateEvent = function (msg) {
      return function (model) {
          return function (event) {
              var updatedModel = Utils_Lens.over(_friendships)(Dunbar_State.processEvent(event))(model);
              var effect = Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Data_Functor["void"](Effect_Aff.functorAff)(store.append(event)))(function () {
                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(msg);
              });
              return {
                  effects: [ effect ],
                  model: updatedModel,
  ...
  var fireStateEvents = function (msg) {
      return function (model) {
          return function (events) {
              var updatedModel = Utils_Lens.over(_friendships)(function (f) {
                  return Data_Foldable.foldr(Data_Foldable.foldableArray)(Dunbar_State.processEvent)(f)(events);
              })(model);
              var effect = Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Data_Functor["void"](Effect_Aff.functorAff)(Data_Traversable["for"](Effect_Aff.applicativeAff)(Data_Traversable.traversableArray)(events)(store.append)))(function () {
                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(msg);
              });
              return {
                  effects: [ effect ],
  ...
  var update = function (model) {
      return function (v) {
          ...
          if (v instanceof LoadEvents) {
              var effect = Control_Bind.bind(Effect_Aff.bindAff)(store.retrieveAll)(function (eventsE) {
                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Either.either((function () {
                      var $30 = Data_Show.show(Effect_Exception.showError);
                      return function ($31) {
                          return AlertError.create($30($31));
                      };
                  })())(LoadedEvents.create)(eventsE));
              });
              return {
                  effects: [ effect ],
                  model: model,
          ...
          if (v instanceof LoadedEvents) {
              var updatedModel = Utils_Lens.over(_friendships)(function (s) {
                  return Data_Foldable.foldr(Data_Foldable.foldableArray)(Dunbar_State.processEvent)(s)(v.value0);
              })(model);
              return Utils_Spork_EventApp.purely(updatedModel);
          };
          ...
          if (v instanceof AddFriend) {
              var event = Control_Apply.apply(Data_Either.applyEither)(Data_Functor.map(Data_Either.functorEither)(Dunbar_State.addFriendEvent)(Utils_Components_Input.parseStringInput(firstNameInput)(model)))(Utils_Components_Input.parseStringInput(lastNameInput)(model));
              ...
              return Data_Either.either(alertError(model))(fireStateEvent(DoNothing.value)(clearedInputs))(event);
          };
          if (v instanceof UpdateFriend) {
              ...
              var events = Data_Traversable.sequence(Data_Traversable.traversableArray)(Data_Either.applicativeEither)([ update1, update2, update3 ]);
              ...
              return Data_Either.either(alertError(model))(fireStateEvents(new Navigate(Dashboard.value))(clearedInputs))(events);
          };
          ...
          if (v instanceof JustSeen && v.value1 instanceof Data_Maybe.Just) {
              ...
              return fireStateEvent(DoNothing.value)(model)(event);
          };
          ...
          throw new Error("Failed pattern match at Dunbar.App (line 220, column 1 - line 220, column 35): " + [ model.constructor.name, v.constructor.name ]);
      };
  };
  ...
  var app = function (currentTime) {
      return {
          ...
          eventStore: Utils_AppendStore.httpAppendStore(Dunbar_State.decodeJsonEvent)(Dunbar_State.encodeJsonEvent)("dunbar"),
  ...
  var app = function (page) {
      return function (now) {
          return {
              ...
              "_state": _state,
              "_eventAppState": _eventAppState,
              eventStore: Utils_AppendStore.httpAppendStore(Goals_Data_Event.decodeJsonEvent)(Goals_Data_Event.encodeJsonEvent)("goals"),
