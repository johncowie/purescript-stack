...
(function($PS) {
  ...
  var appendHTTP = function (dictEncodeJson) {
      return function (s) {
          return function (event) {
              return apiPost(dictEncodeJson)("http://lvh.me:8080?app=" + s)(event);
          };
      };
  };
  ...
  var retrieveAllHTTP = function (dictDecodeJson) {
      return function (s) {
          return apiGet(Data_Argonaut_Decode_Class.decodeArray(dictDecodeJson))("http://lvh.me:8080?app=" + s);
      };
  };
...
(function($PS) {
  ...
  var mkRender = function (eventApp) {
      var $38 = Data_Functor.map(Spork_Html_Core.functorHtml)(Data_Either.Right.create);
      return function ($39) {
          return $38(eventApp.render($39));
      };
  };
          ...
          return function (v2) {
              if (v2 instanceof Data_Either.Right) {
                  ...
                  var storeEventEffects = Data_Functor.mapFlipped(Data_Functor.functorArray)(v3.events)(function (event) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Data_Functor["void"](Effect_Aff.functorAff)(v.eventStore.append(event)))(function () {
              ...
              if (v2 instanceof Data_Either.Left && v2.value0 instanceof LoadEvents) {
                  var load = Control_Bind.bind(Effect_Aff.bindAff)(v.eventStore.retrieveAll)(function (eventsE) {
                      ...
                      throw new Error("Failed pattern match at Utils.Spork.EventApp (line 109, column 11 - line 111, column 48): " + [ eventsE.constructor.name ]);
                  });
                  return {
              ...
              throw new Error("Failed pattern match at Utils.Spork.EventApp (line 92, column 1 - line 96, column 67): " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
          };
      };
  };
