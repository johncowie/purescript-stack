      ...
      return function (url) {
          return function (e) {
              ...
              return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.request({
                  ...
                  throw new Error("Failed pattern match at Utils.AppendStore (line 95, column 3 - line 97, column 40): " + [ result.constructor.name ]);
              });
          };
      };
  };
      ...
      return function (url) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.request({
              ...
              if (result instanceof Data_Either.Right) {
                  ...
                  throw new Error("Failed pattern match at Utils.AppendStore (line 82, column 23 - line 86, column 43): " + [ v.constructor.name ]);
              };
              throw new Error("Failed pattern match at Utils.AppendStore (line 80, column 3 - line 86, column 43): " + [ result.constructor.name ]);
          });
      };
  };
      ...
      return function (url) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.request({
              ...
              if (result instanceof Data_Either.Right) {
                  ...
                  throw new Error("Failed pattern match at Utils.AppendStore (line 70, column 23 - line 72, column 44): " + [ v.constructor.name ]);
              };
              throw new Error("Failed pattern match at Utils.AppendStore (line 68, column 3 - line 72, column 44): " + [ result.constructor.name ]);
          });
      };
  };
...
(function($PS) {
  ...
  var mkRender = function (eventApp) {
      var $43 = Data_Functor.map(Spork_Html_Core.functorHtml)(Data_Either.Right.create);
      return function ($44) {
          return $43(eventApp.render($44));
      };
  };
  ...
  var mkUpdate = function (v) {
      return function (v1) {
          return function (v2) {
              ...
              if (v2 instanceof Data_Either.Left && v2.value0 instanceof LoadEvents) {
                  var load = Control_Bind.bind(Effect_Aff.bindAff)(v.eventStore.retrieveAll)(function (eventsE) {
                      if (eventsE instanceof Data_Either.Right) {
                          return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Either.Left.create(ProcessEvents.create(Data_Functor.map(Data_Functor.functorArray)(function (v3) {
                              return v3.event;
                          })(eventsE.value0))));
                      };
                      ...
                      throw new Error("Failed pattern match at Utils.Spork.EventApp (line 117, column 11 - line 119, column 62): " + [ eventsE.constructor.name ]);
                  });
                  return {
              ...
              throw new Error("Failed pattern match at Utils.Spork.EventApp (line 98, column 1 - line 102, column 67): " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
          };
      };
  };
