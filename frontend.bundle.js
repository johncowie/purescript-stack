      ...
      return function (id) {
          var setter = function (m) {
              return function (vM) {
                  ...
                  throw new Error("Failed pattern match at Utils.Lens (line 59, column 23 - line 61, column 25): " + [ vM.constructor.name ]);
              };
          };
...
(function($PS) {
  ...
  var FullName = (function () {
      function FullName(value0) {
          this.value0 = value0;
      };
      FullName.create = function (value0) {
          return new FullName(value0);
      };
      return FullName;
  })();
  var showFullName = new Data_Show.Show(function (v) {
      return v.value0.firstName + (" " + v.value0.lastName);
  });
  var newTypeFullName = new Data_Newtype.Newtype(function (v) {
      return v.value0;
  }, FullName.create);
...
(function($PS) {
  ...
  var _lastSeen = Utils_Lens.prop(new Data_Symbol.IsSymbol(function () {
      return "lastSeen";
  }))()(Data_Symbol.SProxy.value);
  ...
  var overdueContact = function (i) {
      return function (f) {
          return Control_Bind.bind(Data_Maybe.bindMaybe)(timeSinceLastSeen(i)(f))(function (sinceSeenSecs) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Time_Duration.convertDuration(Data_Time_Duration.durationDays)(Data_Time_Duration.durationSeconds))(f.desiredContactFrequency))(function (v) {
  ...
  var _desiredContactFrequency = Utils_Lens.prop(new Data_Symbol.IsSymbol(function () {
      ...
      return function (url) {
          return function (e) {
              ...
              return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.request({
                  ...
                  throw new Error("Failed pattern match at Utils.AppendStore (line 68, column 3 - line 70, column 40): " + [ result.constructor.name ]);
              });
          };
      };
  };
      ...
      return function (url) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.request({
              ...
              if (result instanceof Data_Either.Right) {
                  ...
                  throw new Error("Failed pattern match at Utils.AppendStore (line 57, column 23 - line 59, column 44): " + [ v.constructor.name ]);
              };
              throw new Error("Failed pattern match at Utils.AppendStore (line 55, column 3 - line 59, column 44): " + [ result.constructor.name ]);
          });
      };
  };
          ...
          return function (v2) {
              ...
              if (v2 instanceof Data_Either.Left && v2.value0 instanceof LoadEvents) {
                  var load = Control_Bind.bind(Effect_Aff.bindAff)(v.eventStore.retrieveAll)(function (eventsE) {
                      ...
                      throw new Error("Failed pattern match at Utils.Spork.EventApp (line 118, column 11 - line 120, column 62): " + [ eventsE.constructor.name ]);
                  });
                  return {
              ...
              throw new Error("Failed pattern match at Utils.Spork.EventApp (line 99, column 1 - line 103, column 67): " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
          };
      };
  };
...
(function($PS) {
  ...
  var timeElapsedPercentage = function (now) {
      return function (v) {
          ...
          var startMillis = instantMillis(Data_DateTime_Instant.fromDateTime(v.start));
          var endMillis = instantMillis(Data_DateTime_Instant.fromDateTime(v.end));
  ...
  var isInProgress = function (now) {
      return function (v) {
          ...
          return Data_Ord.lessThanOrEq(Data_DateTime.ordDateTime)(v.start)(nowDT) && (Data_Ord.greaterThanOrEq(Data_DateTime.ordDateTime)(v.end)(nowDT) && v.amountDone < Data_Int.toNumber(v.target));
      };
  };
  var isFuture = function (now) {
      return function (v) {
          var nowDT = Data_DateTime_Instant.toDateTime(now);
          return Data_Ord.greaterThan(Data_DateTime.ordDateTime)(v.start)(nowDT);
      };
  };
  var isExpired = function (now) {
      return function (v) {
          var nowDT = Data_DateTime_Instant.toDateTime(now);
          return Data_Ord.lessThan(Data_DateTime.ordDateTime)(v.end)(nowDT) || v.amountDone >= Data_Int.toNumber(v.target);
      };
  };
  var isCurrent = function (now) {
      return function (v) {
          var nowDT = Data_DateTime_Instant.toDateTime(now);
          return Data_Ord.lessThanOrEq(Data_DateTime.ordDateTime)(v.start)(nowDT) && Data_Ord.greaterThanOrEq(Data_DateTime.ordDateTime)(v.end)(nowDT);
      };
  };
  ...
  var _start = Control_Semigroupoid.composeFlipped(Utils_Lens.lensSemigroupoid)(Utils_Lens["_newtype"](newtypeGoal))(Utils_Lens.prop(new Data_Symbol.IsSymbol(function () {
      return "start";
  }))()(Data_Symbol.SProxy.value));
  ...
  var _end = Control_Semigroupoid.composeFlipped(Utils_Lens.lensSemigroupoid)(Utils_Lens["_newtype"](newtypeGoal))(Utils_Lens.prop(new Data_Symbol.IsSymbol(function () {
      return "end";
  }))()(Data_Symbol.SProxy.value));
...
(function($PS) {
  ...
  var _due = Utils_Lens.newtypeProp(newtypeGoal)(new Data_Symbol.IsSymbol(function () {
      return "due";
  }))()(Data_Symbol.SProxy.value);
  var _completionDate = Utils_Lens.newtypeProp(newtypeGoal)(new Data_Symbol.IsSymbol(function () {
...
(function($PS) {
  ...
  var rollbackEvent = function (v) {
      ...
      throw new Error("Failed pattern match at Goals.Data.State (line 72, column 1 - line 72, column 49): " + [ v.constructor.name ]);
  };
  var processEvent = function (v) {
      if (v instanceof Goals_Data_Event.AddGoal) {
      ...
      throw new Error("Failed pattern match at Goals.Data.State (line 64, column 1 - line 64, column 48): " + [ v.constructor.name ]);
  };
