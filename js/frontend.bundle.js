...
(function($PS) {
  ...
  var startLogin = function (config) {
      return Control_Bind.bind(Effect_Aff.bindAff)(getGoogleRedirect(config.apiRoot)(config.frontendRoot))(function (redirect) {
          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(loginPage(redirect));
      });
  };
  var finishLogin = function (config) {
      return function (code) {
          return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(getToken(config.apiRoot)(code)(config.frontendRoot))(function (token) {
  ...
  var main_ = function (config) {
      return function __do() {
          ...
          if (codeM instanceof Data_Maybe.Nothing) {
              ...
              throw new Error("Failed pattern match at Main (line 89, column 7 - line 91, column 50): " + [ cookieM.constructor.name ]);
          };
          throw new Error("Failed pattern match at Main (line 85, column 3 - line 91, column 50): " + [ codeM.constructor.name ]);
      };
  };
  var main = main_({
