...
(function($PS) {
  ...
  var mkRender = function (eventApp) {
      var $63 = Data_Functor.map(Spork_Html_Core.functorHtml)(External.create);
      return function ($64) {
          return $63(eventApp.render($64));
      };
  };
                  ...
                  return function (event) {
                      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Monad_Except_Trans.ExceptT(Data_Functor.map(Effect_Aff.functorAff)(mapLeft(Data_Show.show(Effect_Exception.showError)))(eventStore.append(event))))(function (eventId) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))((function () {
                              var $28 = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(eventId)(10) === 0;
                              if ($28) {
                                  return Control_Monad_Except_Trans.ExceptT(Data_Functor.map(Effect_Aff.functorAff)(mapLeft(Data_Show.show(Effect_Exception.showError)))(snapshotStore.saveSnapshot({
                                      state: updatedState,
                                      upToEvent: eventId
                                  })));
                              };
  ...
  var internalUpdate = function (v) {
      return function (model) {
          return function (v1) {
              ...
              throw new Error("Failed pattern match at Utils.Spork.EventApp (line 138, column 1 - line 142, column 65): " + [ v.constructor.name, model.constructor.name, v1.constructor.name ]);
          };
      };
  };
  var mkUpdate = function (app) {
      return function (model) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Utils.Spork.EventApp (line 167, column 1 - line 171, column 59): " + [ app.constructor.name, model.constructor.name, v.constructor.name ]);
          };
      };
  };
      ...
      return function (googleCode) {
          return function (redirect) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Api.getAccessToken(apiRoot)(googleCode)(redirect))(function (respE) {
                  ...
                  throw new Error("Failed pattern match at Main (line 30, column 3 - line 32, column 41): " + [ respE.constructor.name ]);
              });
          };
      };
  };
  var getGoogleRedirect = function (apiRoot) {
      return function (redirect) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Api.getOAuthRedirect(apiRoot)(redirect))(function (respE) {
              ...
              throw new Error("Failed pattern match at Main (line 38, column 3 - line 40, column 41): " + [ respE.constructor.name ]);
          });
      };
  };
  ...
  var main_ = function (config) {
      return function __do() {
          ...
          if (codeM instanceof Data_Maybe.Nothing) {
              ...
              throw new Error("Failed pattern match at Main (line 90, column 7 - line 92, column 50): " + [ cookieM.constructor.name ]);
          };
          throw new Error("Failed pattern match at Main (line 86, column 3 - line 92, column 50): " + [ codeM.constructor.name ]);
      };
  };
  var main = main_({
