  ...
  var httpSnapshotStore = function (dictDecodeJson) {
      return function (dictEncodeJson) {
          return function (rootUrl) {
              return function (app) {
                  return {
                      retrieveLatestSnapshot: retrieveLatestSnapshotHTTP(dictDecodeJson)(rootUrl)(app),
                      saveSnapshot: saveSnapshotHTTP(dictEncodeJson)(rootUrl)(app)
                  };
              };
          };
      };
      ...
      return function (dictEncodeJson) {
          return function (dictDecodeJson1) {
              return function (rootUrl) {
                  return function (appId) {
                      return {
                          append: appendHTTP(dictEncodeJson)(dictDecodeJson1)(rootUrl)(appId),
                          retrieveAll: retrieveAllHTTP(dictDecodeJson1)(dictDecodeJson)(rootUrl)(appId),
                          retrieveAfter: retrieveAfterHTTP(dictDecodeJson1)(dictDecodeJson)(rootUrl)(appId)
                      };
                  };
              };
          };
