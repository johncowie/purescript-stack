...
(function($PS) {
  ...
  var ApiToken = function (x) {
      return x;
  };
  var ApiRoot = function (x) {
      return x;
  };
  var newtypeApiToken = new Data_Newtype.Newtype(function (n) {
      return n;
  }, ApiToken);
              ...
              return function (path) {
                  return function (e) {
                      ...
                      return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.request({
                          ...
                          url: Data_Newtype.unwrap(newtypeApiRoot)(config.url) + path,
                          headers: [ new Affjax_RequestHeader.RequestHeader("AuthToken", Data_Newtype.unwrap(newtypeApiToken)(config.token)) ],
                          content: body,
                          ...
                          if (result instanceof Data_Either.Right) {
                              ...
                              throw new Error("Failed pattern match at Utils.AppendStore (line 118, column 23 - line 121, column 36): " + [ v.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at Utils.AppendStore (line 116, column 3 - line 121, column 36): " + [ result.constructor.name ]);
                      });
                  };
              };
          };
              ...
              return function (appId) {
                  return function (event) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(apiPost(dictEncodeJson)(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(dictDecodeJson)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                          return "id";
                      }))()())())(config)("?app=" + appId)(event))(function (v) {
          ...
          return function (app) {
              return function (snapshot) {
                  return Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Monad_Except_Trans.ExceptT(apiPost(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(dictEncodeJson)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonInt)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                      ...
                      return "state";
                  }))())())(decodeJsonIgnored)(config)("/snapshots?app=" + app)(snapshot)))(function (v) {
          ...
          return function (path) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.request({
                  ...
                  if (result instanceof Data_Either.Right) {
                      ...
                      throw new Error("Failed pattern match at Utils.AppendStore (line 103, column 23 - line 107, column 43): " + [ v.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Utils.AppendStore (line 101, column 3 - line 107, column 43): " + [ result.constructor.name ]);
              });
          };
      };
  };
  ...
  var httpSnapshotStore = function (dictDecodeJson) {
      return function (dictEncodeJson) {
          return function (config) {
              return function (app) {
                  return {
                      retrieveLatestSnapshot: retrieveLatestSnapshotHTTP(dictDecodeJson)(config)(app),
                      saveSnapshot: saveSnapshotHTTP(dictEncodeJson)(config)(app)
                  };
              };
          };
      };
          ...
          return function (path) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.request({
                  ...
                  if (result instanceof Data_Either.Right) {
                      ...
                      throw new Error("Failed pattern match at Utils.AppendStore (line 91, column 23 - line 93, column 44): " + [ v.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Utils.AppendStore (line 89, column 3 - line 93, column 44): " + [ result.constructor.name ]);
              });
          };
      };
  };
              ...
              return function (appId) {
                  return function (eventId) {
                      return apiGet(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(dictDecodeJson1)(Data_Argonaut_Decode_Class.gDecodeJsonCons(dictDecodeJson)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                          ...
                          return "event";
                      }))()())()))(config)("?app=" + (appId + ("&after=" + Data_Show.show(Data_Show.showInt)(eventId))));
                  };
              };
          };
      };
      ...
      return function (dictEncodeJson) {
          return function (dictDecodeJson1) {
              return function (config) {
                  return function (appId) {
                      return {
                          append: appendHTTP(dictEncodeJson)(dictDecodeJson1)(config)(appId),
                          retrieveAll: retrieveAllHTTP(dictDecodeJson1)(dictDecodeJson)(config)(appId),
                          retrieveAfter: retrieveAfterHTTP(dictDecodeJson1)(dictDecodeJson)(config)(appId)
                      };
                  };
              };
          };
  ...
  exports["newtypeApiToken"] = newtypeApiToken;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Utils.ExceptT"] = $PS["Utils.ExceptT"] || {};
  var exports = $PS["Utils.ExceptT"];
  var Data_Either = $PS["Data.Either"];
  var mapError = function (f) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Utils.ExceptT (line 17, column 1 - line 17, column 63): " + [ f.constructor.name, v.constructor.name ]);
      };
  };
...
(function($PS) {
  "use strict";
  $PS["Utils.HttpClient"] = $PS["Utils.HttpClient"] || {};
  var exports = $PS["Utils.HttpClient"];
  var Affjax = $PS["Affjax"];
  var Affjax_ResponseFormat = $PS["Affjax.ResponseFormat"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  ...
  var Effect_Aff = $PS["Effect.Aff"];
  var Effect_Exception = $PS["Effect.Exception"];
  var Utils_ExceptT = $PS["Utils.ExceptT"];                
  var toError = function ($5) {
      return Effect_Exception.error(Affjax.printError($5));
  };
  var decodeError = function (body) {
      return function (errMsg) {
          return Effect_Exception.error(errMsg + ("\x0a" + ("Body was: " + Data_Argonaut_Core.stringify(body))));
      };
  };
  var jsonRequest_ = function (req) {
      return function (decoder) {
          return Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Monad_Except_Trans.ExceptT(Data_Functor.map(Effect_Aff.functorAff)(Utils_ExceptT.mapError(toError))(Affjax.request(req))))(function (response) {
              return Control_Monad_Except_Trans.ExceptT(Data_Functor.map(Effect_Aff.functorAff)(Utils_ExceptT.mapError(decodeError(response.body)))(decoder(response.body)));
          }));
      };
  };
  var getJson_ = function (dictDecodeJson) {
      return function (requestUpdate) {
          return function (url) {
              ...
              var decoder = (function () {
                  var $6 = Control_Applicative.pure(Effect_Aff.applicativeAff);
                  var $7 = Data_Argonaut_Decode_Class.decodeJson(dictDecodeJson);
                  return function ($8) {
                      return $6($7($8));
                  };
              })();
              return jsonRequest_(request)(decoder);
          };
      };
  };
  var getJson = function (dictDecodeJson) {
      return getJson_(dictDecodeJson)(Control_Category.identity(Control_Category.categoryFn));
  };
...
(function($PS) {
  ...
  var Utils_HttpClient = $PS["Utils.HttpClient"];                
  var getOAuthRedirect = function (apiRoot) {
      return function (redirect) {
          return Utils_HttpClient.getJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
              return "redirect";
          }))()())())(Data_Newtype.unwrap(Utils_AppendStore.newtypeApiRoot)(apiRoot) + ("/login?redirect=" + redirect));
      };
  };
  var getAccessToken = function (apiRoot) {
      return function (code) {
          return function (redirect) {
              return Utils_HttpClient.getJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                  return "accessToken";
              }))()())())(Data_Newtype.unwrap(Utils_AppendStore.newtypeApiRoot)(apiRoot) + ("/google?redirect=" + (redirect + ("&code=" + code))));
          };
      };
  };
  exports["getOAuthRedirect"] = getOAuthRedirect;
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Browser.Cookies.Data"] = $PS["Browser.Cookies.Data"] || {};
  var exports = $PS["Browser.Cookies.Data"];
  var Data_Array = $PS["Data.Array"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_Functor = $PS["Data.Functor"];
  ...
  var CookieEncoder = function (encode) {
      this.encode = encode;
  };
  var sameSiteCookieEncoder = new CookieEncoder(function (v) {
      if (v instanceof Lax) {
          return "lax";
      };
      ...
      throw new Error("Failed pattern match at Browser.Cookies.Data (line 58, column 1 - line 60, column 29): " + [ v.constructor.name ]);
  });
  var numberCookieEncoder = new CookieEncoder(function (num) {
      return Data_Show.show(Data_Show.showNumber)(num);
  });            
  var newtypeCookie = new Data_Newtype.Newtype(function (n) {
      return n;
  }, Cookie);
  var jsDateCookieEncoder = new CookieEncoder(function (d) {
      return Data_JSDate.toUTCString(d);
  });
  var encode = function (dict) {
      return dict.encode;
  };
  var cookieOptsEncoder = new CookieEncoder(function (v) {
      var optMaybies = [ Data_Functor.map(Data_Maybe.functorMaybe)(function (n) {
          return "max-age=" + encode(numberCookieEncoder)(n);
      })(v.maxAge), Data_Functor.map(Data_Maybe.functorMaybe)(function (d) {
          return "expires=" + encode(jsDateCookieEncoder)(d);
      })(v.expires), (function () {
          if (v.secure) {
              return new Data_Maybe.Just("secure");
          };
          return Data_Maybe.Nothing.value;
      })(), (function () {
          if (v.httpOnly) {
              return new Data_Maybe.Just("httponly");
          };
          return Data_Maybe.Nothing.value;
      })(), Data_Functor.map(Data_Maybe.functorMaybe)(function (ss) {
          return "samesite=" + encode(sameSiteCookieEncoder)(ss);
      })(v.samesite), Data_Functor.map(Data_Maybe.functorMaybe)(function (str) {
          return "domain=" + str;
      })(v.domain), Data_Functor.map(Data_Maybe.functorMaybe)(function (str) {
          return "path=" + str;
      })(v.path) ];
      return Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)("; ")(Data_Array.catMaybes(optMaybies));
  });
  var cookieEncoder = new CookieEncoder(function (v) {
      return v.key + ("=" + v.value);
  });
  var setCookieEncoder = new CookieEncoder(function (v) {
      return Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)("; ")(Data_Array.catMaybes([ new Data_Maybe.Just(encode(cookieEncoder)(v.cookie)), Data_Functor.map(Data_Maybe.functorMaybe)(encode(cookieOptsEncoder))(v.opts) ]));
  });
  exports["encode"] = encode;
  exports["newtypeCookie"] = newtypeCookie;
  exports["setCookieEncoder"] = setCookieEncoder;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Browser.Cookies.Internal"] = $PS["Browser.Cookies.Internal"] || {};
  var exports = $PS["Browser.Cookies.Internal"];
  var Data_Array = $PS["Data.Array"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_String_Common = $PS["Data.String.Common"];                
  var splitOnSemicolon = function (str) {
      return Data_Functor.map(Data_Functor.functorArray)(Data_String_Common.trim)(Data_String_Common.split(";")(str));
  };
  var splitOnEquals = function (str) {
      return Data_Functor.map(Data_Functor.functorArray)(Data_String_Common.trim)(Data_String_Common.split("=")(str));
  };
  var findCookie = function (dictFoldable) {
      return function (k) {
          return function (cookies) {
              ...
              return Data_Foldable.find(dictFoldable)(matchCookie)(cookies);
          };
      };
  };
  var bakeCookies = function (str) {
      var arrToCookie = function (v) {
          if (v.length === 2) {
      ...
      return Data_Array.catMaybes(Data_Functor.map(Data_Functor.functorArray)(Data_Functor.map(Data_Functor.functorFn)(arrToCookie)(splitOnEquals))(splitOnSemicolon(str)));
  };
...
(function($PS) {
  ...
  "use strict";
  $PS["Browser.Cookie"] = $PS["Browser.Cookie"] || {};
  var exports = $PS["Browser.Cookie"];
  var $foreign = $PS["Browser.Cookie"];
  var Browser_Cookies_Data = $PS["Browser.Cookies.Data"];
  var Browser_Cookies_Internal = $PS["Browser.Cookies.Internal"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_Functor = $PS["Data.Functor"];
  var Effect = $PS["Effect"];                
  var setCookie = function (sc) {
      return $foreign["_setCookie"](Browser_Cookies_Data.encode(Browser_Cookies_Data.setCookieEncoder)(sc));
  };
  var getCookies = Data_Functor.map(Effect.functorEffect)(Browser_Cookies_Internal.bakeCookies)($foreign["_getCookies"]);
  var getCookie = function (k) {
      return Data_Functor.map(Effect.functorEffect)(Browser_Cookies_Internal.findCookie(Data_Foldable.foldableArray)(k))(getCookies);
  };
...
(function($PS) {
  ...
  var redirect = function (url) {
      return function __do() {
          ...
          return Web_HTML_Location.replace(url)(location)();
      };
  };
  ...
  var getQueryParam = function (k) {
      return function (url) {
          return Data_Map_Internal.lookup(Data_Ord.ordString)(k)(getQueryParams(url));
      };
  };
  ...
  var app = function (config) {
      return function (currentTime) {
          return {
              ...
              eventStore: Utils_AppendStore.httpAppendStore(Dunbar_State.decodeJsonEvent)(Dunbar_State.encodeJsonEvent)(Data_Argonaut_Decode_Class.decodeJsonInt)(config.apiConfig)("dunbar"),
      ...
      return function (page) {
          return function (now) {
              return {
                  ...
                  "_state": _state,
                  "_eventAppState": _eventAppState,
                  eventStore: Utils_AppendStore.httpAppendStore(Goals_Data_Event.decodeJsonEvent)(Goals_Data_Event.encodeJsonEvent)(Data_Argonaut_Decode_Class.decodeJsonInt)(config.apiConfig)("goals"),
                  snapshotStore: Utils_AppendStore.httpSnapshotStore(Goals_Data_State.decodeJsonGoalState)(Goals_Data_State.encodeJsonGoalState)(config.apiConfig)("goals"),
...
(function($PS) {
  ...
  var Utils_Url = $PS["Utils.Url"];                
  var setTokenCookie = function (key) {
      return function (value) {
          var cookie = {
              key: key,
              value: value
          };
          return Browser_Cookie.setCookie({
              cookie: cookie,
              opts: Data_Maybe.Nothing.value
          });
      };
  };
  var routeApp = function (api) {
      return function (path) {
          if (path.length === 1 && path[0] === "couplit") {
              return Couplit_App.runApp;
          };
          if (path.length === 1 && path[0] === "dunbar") {
              return Dunbar_App.runApp(Dunbar_App.mkConfig(api));
          };
          if (path.length === 1 && path[0] === "exp") {
              return Experiment.main;
          };
          if (path.length === 1 && path[0] === "lib") {
              return Utils_Components_Lib.main;
          };
          return Goals_App.runApp(Goals_App.mkConfig(api));
      };
  };
  var loginButton = function (googleOAuthUrl) {
      return Spork_Html_Elements.div([  ])([ Spork_Html_Elements.a([ Spork_Html_Properties.href(googleOAuthUrl) ])([ Spork_Html_Core.text("Login") ]) ]);
  };
  var loginPage = function (googleOAuthUrl) {
      var update = function (m) {
          return function (a) {
              return m;
          };
      ...
      var render = function (m) {
          return loginButton(googleOAuthUrl);
      };
      var app = {
          init: Data_Unit.unit,
          update: update,
      ...
      return function __do() {
          var a = Spork_PureApp.makeWithSelector(app)("#app")();
          return a.run();
      };
  };
  var getToken = function (apiRoot) {
      return function (googleCode) {
          return function (redirect) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Api.getAccessToken(apiRoot)(googleCode)(redirect))(function (respE) {
                  if (respE instanceof Data_Either.Right) {
                      return Control_Applicative.pure(Effect_Aff.applicativeAff)(respE.value0.accessToken);
                  };
                  if (respE instanceof Data_Either.Left) {
                      return Effect_Exception_Unsafe.unsafeThrow(Data_Show.show(Effect_Exception.showError)(respE.value0));
                  };
                  throw new Error("Failed pattern match at Main (line 29, column 3 - line 31, column 41): " + [ respE.constructor.name ]);
              });
          };
      };
  };
  var getGoogleRedirect = function (apiRoot) {
      return function (redirect) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Api.getOAuthRedirect(apiRoot)(redirect))(function (respE) {
              if (respE instanceof Data_Either.Right) {
                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(respE.value0.redirect);
              };
              if (respE instanceof Data_Either.Left) {
                  return Effect_Exception_Unsafe.unsafeThrow(Data_Show.show(Effect_Exception.showError)(respE.value0));
              };
              throw new Error("Failed pattern match at Main (line 37, column 3 - line 39, column 41): " + [ respE.constructor.name ]);
          });
      };
  };
  var startLogin = function (config) {
      return Control_Bind.bind(Effect_Aff.bindAff)(getGoogleRedirect(config.apiRoot)(config.frontendRoot + "/google"))(function (redirect) {
          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(loginPage(redirect));
      });
  };
  var finishLogin = function (config) {
      return function (url) {
          return Effect_Aff.launchAff_((function () {
              var codeM = Utils_Url.getQueryParam("code")(url);
              if (codeM instanceof Data_Maybe.Just) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(getToken(config.apiRoot)(codeM.value0)(config.frontendRoot + "/google"))(function (token) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(setTokenCookie("token")(token)))(function () {
                          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Utils_Url.redirect(config.frontendRoot));
                      });
                  });
              };
              if (codeM instanceof Data_Maybe.Nothing) {
                  return Effect_Exception_Unsafe.unsafeThrow("no token");
              };
              throw new Error("Failed pattern match at Main (line 67, column 3 - line 72, column 38): " + [ codeM.constructor.name ]);
          })());
      };
  };
  var main_ = function (config) {
      return function __do() {
          var url = Utils_Url.getWindowUrl();
          var path = Utils_Url.getPath(url);
          var $13 = Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(path)([ "google" ]);
          if ($13) {
              return finishLogin(config)(url)();
          };
          var cookieM = Browser_Cookie.getCookie("token")();
          if (cookieM instanceof Data_Maybe.Just) {
              return routeApp({
                  url: config.apiRoot,
                  token: Data_Newtype.wrap(Utils_AppendStore.newtypeApiToken)((Data_Newtype.unwrap(Browser_Cookies_Data.newtypeCookie)(cookieM.value0)).value)
              })(path)();
          };
          if (cookieM instanceof Data_Maybe.Nothing) {
              return Effect_Aff.launchAff_(startLogin(config))();
          };
          throw new Error("Failed pattern match at Main (line 92, column 7 - line 94, column 50): " + [ cookieM.constructor.name ]);
      };
  };
  var main = main_({
      apiRoot: Data_Newtype.wrap(Utils_AppendStore.newtypeApiRoot)("https://dumb-waiter.herokuapp.com"),
      frontendRoot: "https://johncowie.github.io/purescript-stack"
  });
  var dev = main_({
      apiRoot: Data_Newtype.wrap(Utils_AppendStore.newtypeApiRoot)("http://lvh.me:8080"),
      frontendRoot: "http://lvh.me:1234"
  });
  exports["getToken"] = getToken;
  exports["getGoogleRedirect"] = getGoogleRedirect;
...
},{"_process":3,"big-integer":2}],2:[function(require,module,exports){
